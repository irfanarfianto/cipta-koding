...
export default function TestimonialCreate({ clients }: Props) {
    const { data, setData, post, processing, errors, transform } = useForm({
        client_id: 'manual', // 'manual' or ID
        client_name: '',
        client_position: '',
        content: '',
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        // If manual is selected, ensure client_id is null or handled by backend logic
        // The backend likely expects client_id to be nullable.
        transform((data) => ({
            ...data,
